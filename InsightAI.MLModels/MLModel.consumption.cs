...
namespace InsightAI_MLModels
{
    public partial class MLModel
    {
        ...
        public class ModelOutput
        {
            ...
            [ColumnName(@"Classificacao")]
            public uint Classificacao { get; set; }
        ...
        private static string MLNetModelPath = Path.Combine(
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Classificacao");
            if (labelColumn == null)
            {
                throw new Exception("Classificacao column not found. Make sure the name searched for matches the name in the schema.");
            }
