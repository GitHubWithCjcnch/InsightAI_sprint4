...
namespace InsightAI_MLModels
{
    public partial class MLModel
    {
        public const string RetrainFilePath =  @"C:\Users\cjcnc\Downloads\reclamacoes_empresas.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Classificacao",inputColumnName:@"Classificacao",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Classificacao", sentence1ColumnName: @"Reclamacao"))      
